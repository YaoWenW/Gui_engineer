...
class MatrixInputApp(QMainWindow):
    ...
    def initUI(self):
        ...
        matrix_sizes = [(5, 5, 'U'), (7, 7, 'U1'), (3, 3, 'U2'), (4, 4, 'U3'), (4, 4, 'U4'), (2, 2, 'U5')]
        self.matrix_inputs = []
    ...
    def dowmload_csv(self):
        self.dowmload_csv_dialog = qsm_w.Ui_Dialog()
        self.dowmload_csv_dialog.setupUi(self)
        self.dowmload_csv_dialog.retranslateUi(self)
        self.dowmload_csv_dialog.show()
        return
    def upload_csv(self):
    ...
    def convert_to_matrices(self):
        ...
        print('输入的比较矩阵为:', self.matrices)  # 输入的矩阵内容
        ...
        if len(self.sub_w) == 25:
            self.result_label.setText("计算成功！")
            print('全寿命周期阶段主观权重为:', self.sub_w[3:])
